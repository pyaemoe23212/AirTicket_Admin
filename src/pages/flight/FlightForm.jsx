...
import { createFlight } from "../../config/api";
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="input"
                placeholder="e.g. Jan 15, 9:30 AM"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="input"
                placeholder="e.g. Jan 15, 4:30 PM"
              />
            </div>
            <div>
        ...
        <div className="border rounded-md p-5">
          ...
          <textarea
            ...
            rows={4}
            className="input"
            placeholder="Add any additional flight information or special notes..."
          />
        </div>
